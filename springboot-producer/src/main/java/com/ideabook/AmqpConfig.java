 ...
 * @Author: lzh
 * @Description:
 * @Date: Created in 2017/8/17 16:10
 */
@Configuration
public class AmqpConfig {
    ...
    public ConnectionFactory connectionFactory() {
        ...
        connectionFactory.setAddresses("127.0.0.1:5672"); //5672默认的通信端口?
        connectionFactory.setUsername("guest");
        connectionFactory.setPassword("guest");
        connectionFactory.setVirtualHost("/");
        connectionFactory.setPublisherConfirms(true); //必须要设置,设置显示调用，才可以进行消息的回调
